...
namespace GVFS.Common
{
    ...
    /// </summary>
    public class DeprecatedModifiedPathsDatabase : FileBasedCollection
    {
        private ConcurrentHashSet<string> modifiedPaths;

        protected DeprecatedModifiedPathsDatabase(ITracer tracer, PhysicalFileSystem fileSystem, string dataFilePath)
        ...
        public static bool TryLoadOrCreate(ITracer tracer, string dataDirectory, PhysicalFileSystem fileSystem, out DeprecatedModifiedPathsDatabase output, out string error)
        {
            DeprecatedModifiedPathsDatabase temp = new DeprecatedModifiedPathsDatabase(tracer, fileSystem, dataDirectory);
